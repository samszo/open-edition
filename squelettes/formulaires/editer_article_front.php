 ...
 **/
function formulaires_editer_article_front_charger_dist(
	$id_article = 'new',
	$id_rubrique = 0,
	$retour = '',
	$lier_trad = 0,
 ...
 *     Hash du formulaire
 */
function formulaires_editer_article_front_identifier_dist(
	$id_article = 'new',
	$id_rubrique = 0,
	$retour = '',
	$lier_trad = 0,
 ...
 **/
function formulaires_editer_article_front_verifier_dist(
	$id_article = 'new',
	$id_rubrique = 0,
	$retour = '',
	$lier_trad = 0,
	...
	// on ne demande pas le titre obligatoire : il sera rempli a la volee dans editer_article_front si vide
 ...
 **/
function formulaires_editer_article_front_traiter_dist(
	$id_article = 'new',
	$id_rubrique = 0,
	$retour = '',
	$lier_trad = 0,
