...
include_once_check(_ROOT_PLUGINS.'auto/spipdf/v1.0.3/spipdf_fonctions.php');
include_once_check(_ROOT_PLUGINS.'auto/saisies/v2.6.2/saisies_pipelines.php');
$inc=true;
}
...
$val = minipipe('spipdf_affichage_final', $val);
...
static $inc=null;
if (!$inc){
include_once_check(_ROOT_PLUGINS.'auto/trad_rub/v1.2.10/trad_rub_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/cextras/v3.7.1/cextras_pipelines.php');
$inc=true;
}
$val = minipipe('trad_rub_afficher_contenu_objet', $val);
...
include_once_check(_ROOT_PLUGINS_DIST.'sites/sites_pipelines.php');
include_once_check(_ROOT_PLUGINS_DIST.'statistiques/stats_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/compositions/v3.5.3/compositions_pipeline.php');
include_once_check(_ROOT_PLUGINS_DIST.'breves/breves_pipelines.php');
...
include_once_check(_ROOT_PLUGINS_DIST.'urls_etendues/urls_pipeline.php');
include_once_check(_ROOT_PLUGINS.'auto/skeleditor/v2.7.10/inc/skeleditor_autoriser.php');
include_once_check(_ROOT_PLUGINS.'auto/ckeditor/v0.16.19/ckeditor_autorisations.php');
include_once_check(_ROOT_PLUGINS.'auto/cextras/v3.7.1/inc/cextras_autoriser.php');
include_once_check(_ROOT_PLUGINS.'auto/iextras/v3.3.5/inc/iextras_autoriser.php');
include_once_check(_ROOT_PLUGINS.'auto/compositions/v3.5.3/compositions_pipeline.php');
...
$val = minipipe('ckeditor_autoriser', $val);
...
include_once_check(_ROOT_PLUGINS_DIST.'sites/base/sites.php');
include_once_check(_ROOT_PLUGINS_DIST.'svp/base/svp_declarer.php');
include_once_check(_ROOT_PLUGINS.'auto/tradrub/v3.1.2/base/tradrub.php');
include_once_check(_ROOT_PLUGINS.'auto/roles_auteurs/v1.0.1/base/roles_auteurs.php');
include_once_check(_ROOT_PLUGINS.'auto/compositions/v3.5.3/compositions_pipeline.php');
include_once_check(_ROOT_PLUGINS_DIST.'breves/base/breves.php');
include_once_check(_ROOT_PLUGINS_DIST.'medias/base/medias.php');
$inc=true;
...
$val = minipipe('tradrub_declarer_tables_objets_sql', $val);
$val = minipipe('roles_auteurs_declarer_tables_objets_sql', $val);
...
$val = minipipe('roles_auteurs_declarer_tables_auxiliaires', $val);
...
include_once_check(_ROOT_PLUGINS_DIST.'revisions/inc/revisions_pipeline.php');
include_once_check(_ROOT_PLUGINS.'auto/taa/v1.3.14/taa_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/saisies/v2.6.2/saisies_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/trad_rub/v1.2.10/trad_rub_pipelines.php');
$inc=true;
}
...
$val = minipipe('taa_formulaire_charger', $val);
$val = minipipe('saisies_formulaire_charger', $val);
$val = minipipe('trad_rub_formulaire_charger', $val);
return $val;
}
...
include_once_check(_ROOT_PLUGINS.'auto/saisies/v2.6.2/saisies_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/cextras/v3.7.1/cextras_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/iextras/v3.3.5/inc/iextras.php');
$inc=true;
}
...
$val = minipipe('trad_rub_formulaire_traiter', $val);
return $val;
}
...
static $inc=null;
if (!$inc){
include_once_check(_ROOT_PLUGINS.'auto/facteur/v3.4.1/facteur_pipelines.php');
$inc=true;
}
...
include_once_check(_ROOT_PLUGINS_DIST.'porte_plume/porte_plume_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/taa/v1.3.14/taa_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/chosen/v1.6.3/chosen_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/saisies/v2.6.2/saisies_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/trad_rub/v1.2.10/trad_rub_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/ckeditor/v0.16.19/ckeditor_fonctions.php');
include_once_check(_ROOT_PLUGINS_DIST.'compresseur/compresseur_pipeline.php');
$inc=true;
}
...
$val = minipipe('taa_header_prive', $val);
$val = minipipe('chosen_header_prive', $val);
$val = minipipe('saisies_header_prive', $val);
$val = minipipe('trad_rub_header_prive', $val);
...
include_once_check(_ROOT_PLUGINS_DIST.'porte_plume/porte_plume_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/chosen/v1.6.3/chosen_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/roles/v1.8.2/roles_pipelines.php');
$inc=true;
}
...
$val = minipipe('chosen_header_prive_css', $val);
$val = minipipe('roles_header_prive_css', $val);
return $val;
}
...
$val = minipipe('chosen_insert_head', $val);
...
$val = minipipe('chosen_insert_head_css', $val);
return $val;
}
...
$val = minipipe('chosen_jquery_plugins', $val);
$val = minipipe('roles_jquery_plugins', $val);
return $val;
}
...
$val = minipipe('taa_pre_insertion', $val);
$val = minipipe('tradrub_pre_insertion', $val);
$val = minipipe('trad_rub_pre_insertion', $val);
return $val;
}
...
$val = minipipe('taa_recuperer_fond', $val);
$val = minipipe('trad_rub_recuperer_fond', $val);
return $val;
}
// Pipeline styliser 
...
include_once_check(_ROOT_PLUGINS.'auto/facteur/v3.4.1/facteur_ieconfig_metas.php');
include_once_check(_ROOT_PLUGINS.'auto/compositions/v3.5.3/compositions_ieconfig.php');
...
static $inc=null;
if (!$inc){
include_once_check(_ROOT_PLUGINS.'auto/porteplume_equation/pp_latex_pipelines.php');
$inc=true;
}
$val = minipipe('pp_latex_porte_plume_barre_pre_charger', $val);
return $val;
}
...
$val = minipipe('pp_latex_porte_plume_lien_classe_vers_icone', $val);
return $val;
}
...
$val = minipipe('ckeditor_saisies_autonomes', $val);
return $val;
}
...
static $inc=null;
if (!$inc){
include_once_check(_ROOT_PLUGINS.'auto/iextras/v3.3.5/base/iextras.php');
$inc=true;
}
