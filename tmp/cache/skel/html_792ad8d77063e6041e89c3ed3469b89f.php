...
function BOUCLE_restreinteshtml_792ad8d77063e6041e89c3ed3469b89f(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('../prive/squelettes/navigation/accueil.html','html_792ad8d77063e6041e89c3ed3469b89f','_restreintes',8,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
// Temps de compilation total: 3.754 ms
//

function html_792ad8d77063e6041e89c3ed3469b89f($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
'
	...
	' .
(($t1 = BOUCLE_restreinteshtml_792ad8d77063e6041e89c3ed3469b89f($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
		<div class="liste">
			<h4>' .
...
'
	...
	' .
pipeline( 'accueil_informations' , recuperer_fond( 'prive/squelettes/inclure/accueil-information' , array_merge($Pile[0],array()), array('compil'=>array('../prive/squelettes/navigation/accueil.html','html_792ad8d77063e6041e89c3ed3469b89f','',0,$GLOBALS['spip_lang'])), _request('connect')) ) .
boite_fermer());

	return analyse_resultat_skel('html_792ad8d77063e6041e89c3ed3469b89f', $Cache, $page, '../prive/squelettes/navigation/accueil.html');
}
?>