...
function BOUCLE_pageshtml_2b38105cf212ef0f0cbcde9cef3c41f4(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('../prive/modeles/pagination_prive.html','html_2b38105cf212ef0f0cbcde9cef3c41f4','_pages',7,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
// Temps de compilation total: 6.256 ms
//

function html_2b38105cf212ef0f0cbcde9cef3c41f4($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
(($t1 = BOUCLE_pageshtml_2b38105cf212ef0f0cbcde9cef3c41f4($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
	' .
...
')) :
	...
	return analyse_resultat_skel('html_2b38105cf212ef0f0cbcde9cef3c41f4', $Cache, $page, '../prive/modeles/pagination_prive.html');
}
?>