...
function BOUCLE_soushtml_e1526f492084da63fddcda5fb235cfc6(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('../prive/squelettes/inclure/barre-nav.html','html_e1526f492084da63fddcda5fb235cfc6','_sous',42,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
function BOUCLE_boutonshtml_e1526f492084da63fddcda5fb235cfc6(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('../prive/squelettes/inclure/barre-nav.html','html_e1526f492084da63fddcda5fb235cfc6','_boutons',37,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
(($t1 = strval(interdire_scripts(((((($Pile[$SP]['cle'] == 'menu_accueil')) OR (interdire_scripts(table_valeur($Pile[$SP]['valeur'], 'sousmenu')))) ?' ' :'') ? ' ':vide($Pile['vars'][$_zzz=(string)'li'] = '')))))!=='' ?
	...
	'</a>')) :
		'') .
(($t1 = BOUCLE_soushtml_e1526f492084da63fddcda5fb235cfc6($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		('<ul>' . $t1 . '</ul>') :
		'') .
...
function BOUCLE_creersoushtml_e1526f492084da63fddcda5fb235cfc6(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('../prive/squelettes/inclure/barre-nav.html','html_e1526f492084da63fddcda5fb235cfc6','_creersous',62,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
function BOUCLE_creerhtml_e1526f492084da63fddcda5fb235cfc6(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('../prive/squelettes/inclure/barre-nav.html','html_e1526f492084da63fddcda5fb235cfc6','_creer',60,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
	while ($Pile[$SP]=$iter->fetch()) {
		...
		$t0 .= BOUCLE_creersoushtml_e1526f492084da63fddcda5fb235cfc6($Cache, $Pile, $doublons, $Numrows, $SP);
	}
	$iter->free();
	}
	if (defined("_BOUCLE_PROFILER")
...
function BOUCLE_collaborersoushtml_e1526f492084da63fddcda5fb235cfc6(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('../prive/squelettes/inclure/barre-nav.html','html_e1526f492084da63fddcda5fb235cfc6','_collaborersous',73,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
function BOUCLE_collaborerhtml_e1526f492084da63fddcda5fb235cfc6(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('../prive/squelettes/inclure/barre-nav.html','html_e1526f492084da63fddcda5fb235cfc6','_collaborer',71,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
	while ($Pile[$SP]=$iter->fetch()) {
		...
		$t0 .= BOUCLE_collaborersoushtml_e1526f492084da63fddcda5fb235cfc6($Cache, $Pile, $doublons, $Numrows, $SP);
	}
	$iter->free();
	}
	if (defined("_BOUCLE_PROFILER")
...
// Temps de compilation total: 3.639 ms
//

function html_e1526f492084da63fddcda5fb235cfc6($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
'</a>
	...
	<div id=\'bando_navigation\'>
		<div class=\'largeur clearfix\'>
			' .
(($t1 = BOUCLE_boutonshtml_e1526f492084da63fddcda5fb235cfc6($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		('
			<ul class=\'deroulant\'>
				' . $t1 . '</ul>
			') :
...
'</li></ul>
			' .
(($t1 = BOUCLE_creerhtml_e1526f492084da63fddcda5fb235cfc6($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		('
...
'
			<div id=\'rapides\'>
				' .
(($t1 = BOUCLE_collaborerhtml_e1526f492084da63fddcda5fb235cfc6($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		('
...
executer_balise_dynamique('FORMULAIRE_RECHERCHE_ECRIRE',
	array(),
	array('../prive/squelettes/inclure/barre-nav.html','html_e1526f492084da63fddcda5fb235cfc6','',82,$GLOBALS['spip_lang'])) .
'
			</div>
		</div>
	</div>
...
');
	...
	return analyse_resultat_skel('html_e1526f492084da63fddcda5fb235cfc6', $Cache, $page, '../prive/squelettes/inclure/barre-nav.html');
}
?>