...
function BOUCLE_enlignehtml_83df3ab3753e40d02180ec096320ca49(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('../prive/objets/liste/auteurs_enligne.html','html_83df3ab3753e40d02180ec096320ca49','_enligne',1,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
function html_83df3ab3753e40d02180ec096320ca49($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
	...
	$connect = '';
	$page = (($t1 = BOUCLE_enlignehtml_83df3ab3753e40d02180ec096320ca49($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
<div class=\'en_lignes\'>
<b>' .
...
')) :
	...
	return analyse_resultat_skel('html_83df3ab3753e40d02180ec096320ca49', $Cache, $page, '../prive/objets/liste/auteurs_enligne.html');
}
?>