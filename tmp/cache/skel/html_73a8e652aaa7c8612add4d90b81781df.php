...
function BOUCLE_auteurshtml_73a8e652aaa7c8612add4d90b81781df(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
quete_condition_statut('auteurs.statut','!5poubelle','!5poubelle',''), 
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('../prive/objets/liste/articles.html','html_73a8e652aaa7c8612add4d90b81781df','_auteurs',31,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
function BOUCLE_liste_arthtml_73a8e652aaa7c8612add4d90b81781df(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
  ...
  'lien' => true,
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('../prive/objets/liste/articles.html','html_73a8e652aaa7c8612add4d90b81781df','_liste_art',7,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
BOUCLE_auteurshtml_73a8e652aaa7c8612add4d90b81781df($Cache, $Pile, $doublons, $Numrows, $SP) .
'</div></td>
...
function html_73a8e652aaa7c8612add4d90b81781df($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
') :
		'') .
(($t1 = BOUCLE_liste_arthtml_73a8e652aaa7c8612add4d90b81781df($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
' .
...
');
	...
	return analyse_resultat_skel('html_73a8e652aaa7c8612add4d90b81781df', $Cache, $page, '../prive/objets/liste/articles.html');
}
?>