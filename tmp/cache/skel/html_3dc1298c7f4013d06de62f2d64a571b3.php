...
function BOUCLE_objetshtml_3dc1298c7f4013d06de62f2d64a571b3(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('../prive/themes/spip/picker.css.html','html_3dc1298c7f4013d06de62f2d64a571b3','_objets',56,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
// Temps de compilation total: 5.607 ms
//

function html_3dc1298c7f4013d06de62f2d64a571b3($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
' .
BOUCLE_objetshtml_3dc1298c7f4013d06de62f2d64a571b3($Cache, $Pile, $doublons, $Numrows, $SP) .
'
...
');
	...
	return analyse_resultat_skel('html_3dc1298c7f4013d06de62f2d64a571b3', $Cache, $page, '../prive/themes/spip/picker.css.html');
}
?>