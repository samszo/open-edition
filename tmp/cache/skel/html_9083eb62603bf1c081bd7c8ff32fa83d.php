...
function BOUCLE_artsrhtml_9083eb62603bf1c081bd7c8ff32fa83d(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('../prive/squelettes/inclure/accueil-information.html','html_9083eb62603bf1c081bd7c8ff32fa83d','_artsr',11,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
function BOUCLE_restreintshtml_9083eb62603bf1c081bd7c8ff32fa83d(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
quete_condition_statut('rubriques.statut','!','publie',''), 
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('../prive/squelettes/inclure/accueil-information.html','html_9083eb62603bf1c081bd7c8ff32fa83d','_restreints',10,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
'
				' .
BOUCLE_artsrhtml_9083eb62603bf1c081bd7c8ff32fa83d($Cache, $Pile, $doublons, $Numrows, $SP)
...
function BOUCLE_artshtml_9083eb62603bf1c081bd7c8ff32fa83d(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('../prive/squelettes/inclure/accueil-information.html','html_9083eb62603bf1c081bd7c8ff32fa83d','_arts',6,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
(($t1 = BOUCLE_restreintshtml_9083eb62603bf1c081bd7c8ff32fa83d($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		($t1 . (	'
				' .
...
function BOUCLE_cpthtml_9083eb62603bf1c081bd7c8ff32fa83d(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('../prive/squelettes/inclure/accueil-information.html','html_9083eb62603bf1c081bd7c8ff32fa83d','_cpt',3,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
	while ($Pile[$SP]=$iter->fetch()) {
		...
		$t0 .= BOUCLE_artshtml_9083eb62603bf1c081bd7c8ff32fa83d($Cache, $Pile, $doublons, $Numrows, $SP);
	}
	$iter->free();
	}
	if (defined("_BOUCLE_PROFILER")
...
function BOUCLE_autshtml_9083eb62603bf1c081bd7c8ff32fa83d(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('../prive/squelettes/inclure/accueil-information.html','html_9083eb62603bf1c081bd7c8ff32fa83d','_auts',25,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
function BOUCLE_cptahtml_9083eb62603bf1c081bd7c8ff32fa83d(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('../prive/squelettes/inclure/accueil-information.html','html_9083eb62603bf1c081bd7c8ff32fa83d','_cpta',22,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
	while ($Pile[$SP]=$iter->fetch()) {
		...
		$t0 .= (
BOUCLE_autshtml_9083eb62603bf1c081bd7c8ff32fa83d($Cache, $Pile, $doublons, $Numrows, $SP)
. (	'
			' .
	(($Numrows['_auts']['total'])  ?
			(' ' . (	'
...
// Temps de compilation total: 7.849 ms
//

function html_9083eb62603bf1c081bd7c8ff32fa83d($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
'
' .
(($t1 = BOUCLE_cpthtml_9083eb62603bf1c081bd7c8ff32fa83d($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
	<h4>' .
...
<div class=\'accueil_informations auteurs liste\'>
	' .
(($t1 = BOUCLE_cptahtml_9083eb62603bf1c081bd7c8ff32fa83d($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
		<h4>' .
...
');
	...
	return analyse_resultat_skel('html_9083eb62603bf1c081bd7c8ff32fa83d', $Cache, $page, '../prive/squelettes/inclure/accueil-information.html');
}
?>