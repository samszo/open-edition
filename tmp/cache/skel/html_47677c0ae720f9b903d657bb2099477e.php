...
// Temps de compilation total: 3.044 ms
//

function html_47677c0ae720f9b903d657bb2099477e($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
'<'.'?php echo recuperer_fond( ' . argumenter_squelette('prive/echafaudage/hierarchie/objet') . ', array(\'objet\' => ' . argumenter_squelette(table_valeur($Pile["vars"], (string)'objet', null)) . ',
	...
	\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . '), array("compil"=>array(\'../prive/squelettes/hierarchie/dist.html\',\'html_47677c0ae720f9b903d657bb2099477e\',\'\',9,$GLOBALS[\'spip_lang\']),\'ajax\' => ($v=( ' . argumenter_squelette(@$Pile[0]['ajax']) . '))?$v:true), _request("connect"));
?'.'>
	')) :
			'') .
	'
...
'<'.'?php echo recuperer_fond( ' . argumenter_squelette('prive/echafaudage/hierarchie/objet.sans_rubrique') . ', array(\'objet\' => ' . argumenter_squelette(table_valeur($Pile["vars"], (string)'objet', null)) . ',
	\'id_objet\' => ' . argumenter_squelette(table_valeur($Pile["vars"], (string)'id_objet', null)) . ',
	\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . '), array("compil"=>array(\'../prive/squelettes/hierarchie/dist.html\',\'html_47677c0ae720f9b903d657bb2099477e\',\'\',10,$GLOBALS[\'spip_lang\']),\'ajax\' => ($v=( ' . argumenter_squelette(@$Pile[0]['ajax']) . '))?$v:true), _request("connect"));
?'.'>
	')) :
			'') .
	'
')) :
	...
	return analyse_resultat_skel('html_47677c0ae720f9b903d657bb2099477e', $Cache, $page, '../prive/squelettes/hierarchie/dist.html');
}
?>