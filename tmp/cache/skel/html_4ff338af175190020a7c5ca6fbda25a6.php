...
function BOUCLE_objetshtml_4ff338af175190020a7c5ca6fbda25a6(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('../prive/themes/spip/lists.css.html','html_4ff338af175190020a7c5ca6fbda25a6','_objets',77,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
function BOUCLE_objets2html_4ff338af175190020a7c5ca6fbda25a6(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('../prive/themes/spip/lists.css.html','html_4ff338af175190020a7c5ca6fbda25a6','_objets2',153,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
' .
BOUCLE_objetshtml_4ff338af175190020a7c5ca6fbda25a6($Cache, $Pile, $doublons, $Numrows, $SP) .
'
...
' .
BOUCLE_objets2html_4ff338af175190020a7c5ca6fbda25a6($Cache, $Pile, $doublons, $Numrows, $SP) .
'
');

	return analyse_resultat_skel('html_4ff338af175190020a7c5ca6fbda25a6', $Cache, $page, '../prive/themes/spip/lists.css.html');
}
?>