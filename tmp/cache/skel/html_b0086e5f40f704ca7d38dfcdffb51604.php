...
function BOUCLE_haspostdatehtml_b0086e5f40f704ca7d38dfcdffb51604(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('../prive/squelettes/contenu/accueil.html','html_b0086e5f40f704ca7d38dfcdffb51604','_haspostdate',3,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
'<'.'?php echo recuperer_fond( ' . argumenter_squelette('prive/objets/liste/articles') . ', array_merge('.var_export($Pile[0],1).',array(\'titre\' => ' . argumenter_squelette(_T('public|spip|ecrire:info_article_a_paraitre')) . ',
	...
	\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . ')), array("compil"=>array(\'../prive/squelettes/contenu/accueil.html\',\'html_b0086e5f40f704ca7d38dfcdffb51604\',\'\',6,$GLOBALS[\'spip_lang\']),\'ajax\' => ($v=( ' . argumenter_squelette(@$Pile[0]['ajax']) . '))?$v:true), _request("connect"));
?'.'>
	' .
...
// Temps de compilation total: 1.390 ms
//

function html_b0086e5f40f704ca7d38dfcdffb51604($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
BOUCLE_haspostdatehtml_b0086e5f40f704ca7d38dfcdffb51604($Cache, $Pile, $doublons, $Numrows, $SP) .
'
...
'<'.'?php echo recuperer_fond( ' . argumenter_squelette('prive/objets/liste/articles') . ', array_merge('.var_export($Pile[0],1).',array(\'titre\' => ' . argumenter_squelette(_T('public|spip|ecrire:articles_recents')) . ',
	...
	\'where\' => ' . argumenter_squelette(table_valeur($Pile["vars"], (string)'recentwhere', null)) . ',
	\'nb\' => ' . argumenter_squelette('5') . ',
	\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . ')), array("compil"=>array(\'../prive/squelettes/contenu/accueil.html\',\'html_b0086e5f40f704ca7d38dfcdffb51604\',\'\',12,$GLOBALS[\'spip_lang\']),\'ajax\' => ($v=( ' . argumenter_squelette(@$Pile[0]['ajax']) . '))?$v:true), _request("connect"));
?'.'>
...
'<'.'?php echo recuperer_fond( ' . argumenter_squelette('prive/objets/liste/articles') . ', array_merge('.var_export($Pile[0],1).',array(\'titre\' => ' . argumenter_squelette(table_valeur($Pile["vars"], (string)'titre', null)) . ',
	...
	\'par\' => ' . argumenter_squelette('date') . ',
	\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . ')), array("compil"=>array(\'../prive/squelettes/contenu/accueil.html\',\'html_b0086e5f40f704ca7d38dfcdffb51604\',\'\',17,$GLOBALS[\'spip_lang\']),\'ajax\' => ($v=( ' . argumenter_squelette(@$Pile[0]['ajax']) . '))?$v:true), _request("connect"));
?'.'>
...
(($t1 = strval(pipeline( 'accueil_encours' , recuperer_fond( 'prive/objets/liste/articles' , array_merge($Pile[0],array('titre' => _T('public|spip|ecrire:info_articles_proposes') ,
	...
	'par' => 'date' )), array('ajax' => ($v=( @$Pile[0]['ajax'] ))?$v:true,'compil'=>array('../prive/squelettes/contenu/accueil.html','html_b0086e5f40f704ca7d38dfcdffb51604','',0,$GLOBALS['spip_lang'])), _request('connect')) )))!=='' ?
		((	'
	' .
...
') :
	...
	return analyse_resultat_skel('html_b0086e5f40f704ca7d38dfcdffb51604', $Cache, $page, '../prive/squelettes/contenu/accueil.html');
}
?>