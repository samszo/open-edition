...
function BOUCLE_liste_brehtml_79a102c45c2193fb149eed9af66486ae(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
  ...
  'lien' => true,
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('../plugins-dist/breves/prive/objets/liste/breves.html','html_79a102c45c2193fb149eed9af66486ae','_liste_bre',8,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
// Temps de compilation total: 7.736 ms
//

function html_79a102c45c2193fb149eed9af66486ae($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
') :
		'') .
(($t1 = BOUCLE_liste_brehtml_79a102c45c2193fb149eed9af66486ae($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
' .
...
');
	...
	return analyse_resultat_skel('html_79a102c45c2193fb149eed9af66486ae', $Cache, $page, '../plugins-dist/breves/prive/objets/liste/breves.html');
}
?>